...
class NormalMappingApplication : public vkDisplay::Application
{
public:
	NormalMappingApplication() {}
...
vk::Result
NormalMappingApplication::createResources()
{
	vk::Result result;
	...
	vkDisplay::Image image = createImage("../images/brickwall.jpg");
	mImage = image.image;
...
vk::Result
NormalMappingApplication::createPipeline()
{
	vk::Result result;
...
vk::Result
NormalMappingApplication::createCommandBuffers()
{
	vk::Result result;
...
void
NormalMappingApplication::render(double frameTime, double totalTime)
{
	glm::vec3 eye(0, 2, -5);
	glm::vec3 up(0, -1, 0);
...
int main()
{
	...
	NormalMappingApplication application;
	result = application.createInstance("Normal Mapping", VK_MAKE_VERSION(1, 0, 0));
	result = application.createDevice();
	application.createWindow("Normal Mapping", 800, 600);
