...
class TextureApplication : public vkDisplay::Application
{
public:
	TextureApplication() {}
...
vk::Result
TextureApplication::createResources()
{
	vk::Result result;
	//buffer data
	struct BufferData {
...
vk::Result
TextureApplication::createPipeline()
{
	vk::Result result;
...
vk::Result
TextureApplication::createCommandBuffers()
{
	vk::Result result;
